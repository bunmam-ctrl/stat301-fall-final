...
load("figure_table/data_quality/table_1_abortion_summary.rda")
abortion_summary
```
...
![Missing values in Global Abortion Incidence Dataset.](figure_table/data_quality/abortion_na.png){#fig-abortion-na}
...
load("figure_table/data_quality/table_2_index_summary.rda")
index_summary
```
...
![Missing values in Gender Inequality Index Dataset.](figure_table/data_quality/index_na.png){#fig-index-na}
...
load("figure_table/data_quality/table_3_violence_summary.rda")
violence_summary
```
...
![Missing values in Violence Against Women and Girls Dataset.](figure_table/data_quality/violence_na.png){#fig-violence-na}
...
load("figure_table/data_quality/table_4_social_factor_summary.rda")
...
![Missing values in Gender Inequality Index Dataset.](figure_table/data_quality/social_factor_na.png){#fig-social-factor-na}
...
load("figure_table/data_quality/table_5_china_marital_summary.rda")
...
![Map of abortion cases reported by country, highlighting variations and trends over 28 years.](figure_table/world_vis/global_abortion.png){#fig-1-global-num}
...
![Map of gender equality, measuring disparities in various social, economic, and political areas.](figure_table/world_vis/global_gender.png){#fig-2-global-gender}
...
![Comparison of the change of Gender Inequality Index (GII) from 1990 to 2021 of 5 countries with the highest GII in 2021.](figure_table/africa_asia/gender_time.png){#fig-2-afri-gender-time}
...
The male distribution exhibits a slightly different trend. The curve for `males` is still right-skewed but shows a broader spread, with its  peaks occurring **around 40% to 60%** of secondary education completion (@fig-3-afri-compare-edu). This pattern suggests that men in these regions are more likely to progress through middle school compared to women, though the rightward skew implies that even for men, many do not reach graduation. The more rightward position of the `male` density curve, along with its greater height compared to females between **40% and 100%**, indicates that a larger proportion of men complete their education (@fig-3-afri-compare-edu). This disparity in completion rates between males and females points to deeply ingrained societal norms that prioritize boys' education over girls'. The prioritization of male education reflects a cultural perspective that values men potential economic contributions more highly, while often relegating women to domestic roles with fewer opportunities for economic participating and decision-making power, whereas women remain largely dependent and excluded from such prospects.  
 ...
 ![Examining secondary education rates among individuals aged 25 or older in 2021 across developing regions of Africa, Western, Central, South, and Southeastern Asia.](figure_table/africa_asia/compare_edu.png){#fig-3-afri-compare-edu}
...
![Bar graph based on the survey from 2015 to 2018 highlighting support for different justifications of domestic violence in developing countries](figure_table/africa_asia/domestic_opinion.png){#fig-6-afri-domes-opinion}
...
#| 
load("figure_table/africa_asia/table_1_violence_subregion_category.rda")
...
load("figure_table/africa_asia/table_2_maternal_summary.rda")
maternal_summary
```
...
![Decreasing Trajectory of the Gender Inequality Index in China from 1990 to 2021.](figure_table/china/china_gender_index.png){#fig-1-china-gender-index}


![Comparison of male and female population ratios in China from 1950 to 2021.](figure_table/china/china_gender_pop.png){#fig-2-china-gender-pop}
...
![Comparison of urban and rural marriage trends in China from 2009 to 2017.](figure_table/china/china_mean_marriage.png){#fig-4-china-mean-marriage}

![Comparison of urban and rural divorce rate in China from 2009 to 2017.](figure_table/china/china_mean_divorce.png){#fig-5-china-mean-divorce}
...
load("figure_table/africa_asia/table_1_top_5_gender_inequality.rda")
...
![Map of Abortion Accessibility Across Developing Countries in Western Asia, Africa, Central, South, and Southeastern Asia, Latin America, and Eastern Europe.](figure_table/africa_asia/abor_access.png){#fig-1-afri-abor-access}
...
![Analysis of birth rates per 1,000 women ages 15-19 across developing regions in Africa, Western, Central, South, and Southeastern Asia.](figure_table/africa_asia/birth_rate.png){#fig-5-afri-birth-rate}
...
load("figure_table/china/table_1_china_global_rank.rda")
china_global_rank
```
