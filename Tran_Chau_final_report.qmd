...
```{r}
#| label: The accessibility of abortion in (Western Asia and Africa) (Graph 4a)
...
```{r}
#| label: The accessibility of abortion in developing countries (Eastern and Southeastern Asia, Graph 4b)
...
```{r}
#| label: The accessibility of abortion in developing countries (Latin America, Graph 4c)
# Graph Latin America
...
```{r}
#| label: The accessibility of abortion (Europe, Graph 4d)
