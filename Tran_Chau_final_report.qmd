...
```
```{r}
#| label: Graph 3a The accessibility of abortion in developing countries (Africa)
...
```{r}
#| label: Graph 3b The accessibility of abortion in developing countries (Western Asia and Northern Africa)
...
```
```{r}
#| label: Graph 3c The accessibility of abortion in developing countries (Eastern and Southeastern Asia)
...
```{r}
#| label: Graph 3d The accessibility of abortion in developing countries (Western Asia and Northern Africa)
# Graph "Western Asia and Northern Africa"
map_data_2|>
  filter(subregion.x %in% c("Western Asia", "Northern Africa"))|>
  ggplot()+
...
```{r}
#| label: Graph 3e The accessibility of abortion in developing countries (Latin America)
# Graph Latin America
map_data_2|>
...
```{r}
#| label: Graph 3e The accessibility of abortion in Europe and Northern America
# Graph Europe and Northern America
map_data_2|>
  filter(subregion.x %in%  c("Eastern Europe", "Southern Europe" ))|>
  ggplot()+
  geom_sf(aes(fill = abortion_access), color = "black", size = 0.1) +
  scale_fill_viridis_d(option = "plasma", na.value = "grey80") +
  coord_sf(xlim = c(0, 40), ylim = c(30, 60))  +
  theme_minimal() +
  labs(
    title = "Abortion Access in developing countries",
    subtitle = "Region: Europe and Northern America",
    fill = "Access Level"
  ) +
  theme(
    plot.title = element_text(size = 16, face = "bold", hjust = 0.5),
